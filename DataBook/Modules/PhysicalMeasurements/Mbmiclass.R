...
# BMI Classifications
mbmiclass_c_list_long <- tbls_summary(.mn_pct_md = pct, .variable = c, .cln = bmicln)
...
# OVERWEIGHT (BMI ≥ 25)
mbmiclass_d_list_long <- tbls_summary(.mn_pct_md = pct, .variable = d, .cln = bmicln)
