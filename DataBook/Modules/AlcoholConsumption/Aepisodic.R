...
aepisodic_c_list_long <- tbls_summary(.mn_pct_md = pct, .variable = c)
...
aepisodic_a9_list_long <- tbls_summary(.mn_pct_md = mn, .variable = a9, .cln = clndrinker)
...
readr::write_excel_csv(fs_9_aepisodic_c_joint, here("FactSheet", "09_fs_aepisodic_c.csv"))
