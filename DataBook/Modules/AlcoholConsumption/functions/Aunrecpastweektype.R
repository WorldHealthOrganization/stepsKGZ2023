  ...
  if(!all(i <- rlang::has_name(.data, aunrecpastweektype_names))) {
    ...
    .data %>%
      mutate(
        ...
        a10cln = 2,  
        a10cln = replace(a10cln, a10a<51 & a10b<51 & a10c<51 & a10d<51 &  
                           a10e<51 & a10f<51 & a10g<51, 1), 
        ...
        cln = replace(cln, past7unrec==0, 2),  
        cln = replace(cln, a11==2, 2),
        ...
        a12dwt = a12d*wstep1,
        a12ewt = a12e*wstep1,
        percentunrec_a = a12awt/past7unrecwt,
        percentunrec_b = a12bwt/past7unrecwt,
        percentunrec_c = a12cwt/past7unrecwt,
        percentunrec_d = a12dwt/past7unrecwt,
        percentunrec_e = a12ewt/past7unrecwt
      ) %>%
      filter(cln == 1)
  }
}
