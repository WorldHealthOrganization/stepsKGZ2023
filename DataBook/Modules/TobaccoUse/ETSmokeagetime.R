...
etsmokeagetime_df <- etsmokeagetime(datawt)
...
etsmokeagetime_initiation_list_long <- 
  tbls_summary(.mn_pct_md = mn, .variable = initiation, .cln2 = et2, .cln2_val = 1)
...
etsmokeagetime_duration_list_long <- 
  tbls_summary(.mn_pct_md = mn, .variable = duration, .cln2 = et2, .cln2_val = 1)
