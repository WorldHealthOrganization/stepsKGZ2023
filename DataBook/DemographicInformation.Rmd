...
ceduhigh_c_col_names <- 
  c("Age Group (years)", "n", "% No formal schooling", "% Primary school", 
    "% Basic (not completed) secondary school (8-9 grade)", 
    "% Basic (completed) secondary school (10-11 grade)", 
    "% Initial vocational education (vocational school, liceum)", 
    "% Secondary vocational education (technical college, other college)", 
    "% Higher education")

# column names for region to use with huxtable
ceduhigh_c_reg_col_names <- 
  c("Region", "n", "% No formal schooling", "% Primary school", 
    "% Basic (not completed) secondary school (8-9 grade)", 
    "% Basic (completed) secondary school (10-11 grade)", 
    "% Initial vocational education (vocational school, liceum)", 
    "% Secondary vocational education (technical college, other college)", 
...
# KGZ specific
cethnic_c_col_names <- 
  c("Age Group (years)", "n", "% Kyrgyz", "% Russian", "% Uzbek", "% Other")

# column names for region to use with huxtable
# KGZ specific
cethnic_c_reg_col_names <- 
  c("Region", "n", "% Kyrgyz", "% Russian", "% Uzbek", "% Other")
...
```{r}
cethnic_c_m_w_b$m %>% final_tbl(.disaggregation = m_w_b, 1, "Men", "Ethnic group of respondents", 6)
```

<br>

```{r}
cethnic_c_m_w_b$w %>% final_tbl(.disaggregation = m_w_b, 1, "Women", "Ethnic group of respondents", 6)
```

<br>

```{r}
cethnic_c_m_w_b$b %>% final_tbl(.disaggregation = m_w_b, 1, "Both sexes", "Ethnic group of respondents", 6)
```
...
rbind(cethnic_c_u_r$m_u, cethnic_c_u_r$m_r) %>% 
  final_tbl(.disaggregation = u_r, 1, "Men", "Ethnic group of respondents by type of settlement", 6)
```
...
rbind(cethnic_c_u_r$w_u, cethnic_c_u_r$w_r) %>% 
  final_tbl(.disaggregation = u_r, 1, "Women", "Ethnic group of respondents by type of settlement", 6)
```
...
rbind(cethnic_c_u_r$b_u, cethnic_c_u_r$b_r) %>% 
  final_tbl(.disaggregation = u_r, 1, "Both sexes", "Ethnic group of respondents by type of settlement", 6)
```
...
cethnic_c$b_reg %>% apply_hux(.col_names = cethnic_c_reg_col_names) %>% 
  final_tbl(.disaggregation = reg, 1, "Both sexes", "Ethnic group of respondents by region", 6) 
```
